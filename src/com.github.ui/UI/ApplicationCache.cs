...
abstract class ManagedCacheBase<T> : ScriptObjectSingleton<T> where T : ScriptableObject, IManagedCache
{
    ...
    public abstract TimeSpan DataTimeout {
        get;
    }
    ...
    {
        get {
            return initializedAtString;
        }
        private set {
            initializedAtString = value;
        }
    }

    public bool IsInitialized {
        get {
            return ApplicationCache.Instance.FirstRunAt <= InitializedAt;
        }
    }
