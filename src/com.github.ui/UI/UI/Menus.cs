...
class Menus : ScriptableObject {
  ...
  private const string Menu_Window_Git_Command_Line =
      "Window/GitHub Command Line";
#else
  private const string Menu_Window_Git = "Window/GitHub";
  private const string Menu_Window_Git_Command_Line =
      "Window/GitHub Command Line";
  ...
  public static void Window_Git() { ShowWindow(EntryPoint.ApplicationManager); }

  [MenuItem(Menu_Window_Git_Command_Line)]
  public static void Git_CommandLine() {
    EntryPoint.ApplicationManager.ProcessManager.RunCommandLineWindow(
        NPath.CurrentDirectory);
    EntryPoint.ApplicationManager.UsageTracker
        .IncrementApplicationMenuMenuItemCommandLine();
  }
  ...
  public static void Git_SelectWindow() {
    var window = Resources.FindObjectsOfTypeAll(typeof(Window))
                     .FirstOrDefault() as Window;
    Selection.activeObject = window;
  }

  [MenuItem("GitHub/Restart")]
  public static void Git_Restart() { EntryPoint.Restart(); }
#endif
