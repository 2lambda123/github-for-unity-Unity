...
[Serializable]
public class ChangesTreeNodeDictionary
    : SerializableDictionary<string, ChangesTreeNode> {}
...
public class ChangesTreeNode : TreeNode {
  ...
  [SerializeField]
  private GitStatusEntry gitStatusEntry;
...
public class ChangesTree : Tree<ChangesTreeNode, GitStatusEntryTreeData> {
  ...
  [NonSerialized]
  private bool viewHasFocus;
  [NonSerialized]
  private Object lastActivatedObject;

  [SerializeField]
  public ChangesTreeNodeDictionary assets = new ChangesTreeNodeDictionary();
  [SerializeField]
  public ChangesTreeNodeDictionary folders = new ChangesTreeNodeDictionary();
  [SerializeField]
  public ChangesTreeNodeDictionary checkedFileNodes =
      new ChangesTreeNodeDictionary();
  [SerializeField]
  ...
  [SerializeField]
  public bool isUsingGlobalSelection = false;
  [SerializeField]
  private List<ChangesTreeNode> nodes = new List<ChangesTreeNode>();
  [SerializeField]
  private ChangesTreeNode selectedNode = null;
  ...
  protected override ChangesTreeNode
  CreateTreeNode(string path, string label, int level, bool isFolder,
                 bool isActive, bool isHidden, bool isCollapsed, bool isChecked,
                 GitStatusEntryTreeData? treeData) {
