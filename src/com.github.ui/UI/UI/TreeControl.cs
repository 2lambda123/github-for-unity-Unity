    ...
    where TData : struct, ITreeData
{
    ...
    public bool IsInitialized {
        get {
            return Nodes != null && Nodes.Count > 0 && !String.IsNullOrEmpty(Nodes[0].Path);
        }
    }
    ...
    public abstract bool ViewHasFocus {
        get;
        set;
    }
...
public class TreeNode : ITreeNode
{
    ...
    {
        get {
            return treeIsCheckable;
        }
        set {
            treeIsCheckable = value;
        }
    }
