...
abstract class Subview : IView
{
    ...
    protected IUsageTracker UsageTracker {
        get {
            return Manager.UsageTracker;
        }
    }
    protected IOAuthCallbackManager OAuthCallbackManager {
        get {
            return Manager.OAuthCallbackManager;
        }
    }

    public bool HasFocus {
        get {
            return Parent != null && Parent.HasFocus;
        }
    }
    public virtual bool IsBusy
    {
        get {
            return (Manager != null && Manager.IsBusy) || (Repository != null && Repository.IsBusy);
        }
    }
