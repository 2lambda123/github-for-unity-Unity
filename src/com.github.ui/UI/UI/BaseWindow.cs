...
public abstract class BaseWindow : EditorWindow, IView {
  ...
  [NonSerialized]
  private IRepository cachedRepository;
  [NonSerialized]
  private bool initializeWasCalled;
  [NonSerialized]
  protected bool inLayout;
  [NonSerialized]
  private bool firstDrawCalled = false;

  public BaseWindow() { RefreshEvents = new Dictionary<CacheType, int>(); }
  ...
  public virtual void Redraw() { Repaint(); }
  ...
  public virtual void DoneRefreshing() { IsRefreshing = false; }
  ...
  public IRepository Repository {
    get { return inLayout ? cachedRepository : Environment.Repository; }
  }
  public bool HasRepository {
    get { return Repository != null; }
  }
  public IUser User {
    get { return cachedUser; }
  }
  public bool HasUser {
