...
abstract class HistoryBase : Subview
{
    ...
    protected abstract HistoryControl HistoryControl {
        get;
        set;
    }
    protected abstract GitLogEntry SelectedEntry {
        get;
        set;
    }
    protected abstract ChangesTree TreeChanges {
        get;
        set;
    }
    protected abstract Vector2 DetailsScroll {
        get;
        set;
    }
