...
class Styles {
  public const float BaseSpacing = 10f, BrowseButtonWidth = 25f,
                     BroadModeLimit = 500f, NarrowModeLimit = 300f,
                     ModeNotificationDelay = .5f,
                     BroadModeBranchesMinWidth = 200f,
                     BroadModeBranchesRatio = .4f, InitialStateAreaWidth = 200f,
                     LocksEntryHeight = 42f, LocksSummaryHeight = 5f,
                     LocksUserHeight = 5f, LocksDateHeight = 5f,
                     HistoryEntryHeight = 40f, HistorySummaryHeight = 16f,
                     HistoryDetailsHeight = 16f, HistoryEntryPadding = 16f,
                     HistoryChangesIndentation = 17f, CommitAreaMinHeight = 16f,
                     CommitAreaDefaultRatio = .4f,
                     CommitAreaMaxHeight = 12 * 15f, CommitAreaPadding = 5f,
                     PublishViewSpacingHeight = 5f, MinCommitTreePadding = 20f,
                     FoldoutWidth = 11f, FoldoutIndentation = -2f,
                     TreePadding = 12f, TreeIndentation = 12f,
                     TreeRootIndentation = -5f, TreeVerticalSpacing = 3f,
                     CommitIconSize = 16f, CommitIconHorizontalPadding = -5f,
                     BranchListIndentation = 20f, BranchListSeparation = 15f,
                     RemotesTotalHorizontalMargin = 37f, RemotesNameRatio = .2f,
                     RemotesUserRatio = .2f, RemotesHostRation = .5f,
  ...
  private static GUIStyle label, boldLabel, centeredErrorLabel, errorLabel,
      deletedFileLabel, longMessageStyle, headerBoxStyle, headerStyle,
      headerBranchLabelStyle, headerUrlLabelStyle, headerRepoLabelStyle,
      fileHistoryLogTitleStyle, headerTitleStyle, headerDescriptionStyle,
      toolbarButtonStyle, historyLockStyle, historyEntrySummaryStyle,
      historyEntryDetailsStyle, historyEntryDetailsRightStyle,
      historyFileTreeBoxStyle, commitFileAreaStyle, commitButtonStyle,
      textFieldStyle, boldCenteredLabel, centeredLabel,
      commitDescriptionFieldStyle, toggleMixedStyle, authHeaderBoxStyle,
      lockedFileRowSelectedStyle, lockedFileRowStyle, genericTableBoxStyle,
      historyDetailsTitleStyle, historyDetailsMetaInfoStyle, genericBoxStyle,
      hyperlinkStyle, selectedArea, selectedLabel, progressAreaBackStyle,
      labelNoWrap, invisibleLabel, locksViewLockedByStyle,
      locksViewLockedBySelectedStyle;

  public static Texture2D GetFileStatusIcon(GitFileStatus status,
                                            bool isLocked) {
    if (isLocked) {
      switch (status) {
  ...
  public static GUIStyle InvisibleLabel {
    get {
      if (invisibleLabel == null) {
        ...
        invisibleLabel.onFocused.background =
            hierarchyStyle.onFocused.background;
  ...
  public static GUIStyle SelectedLabel {
    get {
      if (selectedLabel == null) {
        ...
        selectedLabel.onFocused.background =
            hierarchyStyle.onFocused.background;
  ...
  public static GUIStyle HistoryEntrySummaryStyle {
    get {
      if (historyEntrySummaryStyle == null) {
        ...
        historyEntrySummaryStyle.contentOffset =
            new Vector2(BaseSpacing * 2, 0);
      }
  ...
  public static GUIStyle HistoryEntryDetailsStyle {
    get {
      if (historyEntryDetailsStyle == null) {
        ...
        historyEntryDetailsStyle.normal.textColor =
            new Color(c.r, c.g, c.b, c.a * 0.7f);

        historyEntryDetailsStyle.onNormal.background =
            Label.onNormal.background;
        historyEntryDetailsStyle.onNormal.textColor = Label.onNormal.textColor;
        historyEntryDetailsStyle.onFocused.background =
            Label.onFocused.background;
        historyEntryDetailsStyle.onFocused.textColor =
            Label.onFocused.textColor;

        historyEntryDetailsStyle.contentOffset =
            new Vector2(BaseSpacing * 2, 0);
      }
  ...
  public static GUIStyle LockedFileRowSelectedStyle {
    get {
      if (lockedFileRowSelectedStyle == null) {
        ...
        lockedFileRowSelectedStyle.normal.background =
            hierarchyStyle.onFocused.background;
        lockedFileRowSelectedStyle.normal.textColor =
            hierarchyStyle.onFocused.textColor;
      }
  ...
  public static GUIStyle HistoryDetailsMetaInfoStyle {
    get {
      if (historyDetailsMetaInfoStyle == null) {
        ...
        historyDetailsMetaInfoStyle.normal.textColor =
  ...
  public static GUIStyle LocksViewLockedByStyle {
    get {
      if (locksViewLockedByStyle == null) {
        ...
        var hierarchyStyle = GUI.skin.FindStyle("PR Label");
        locksViewLockedByStyle.onNormal.background =
            hierarchyStyle.onNormal.background;
        locksViewLockedByStyle.onNormal.textColor =
            hierarchyStyle.onNormal.textColor;
        locksViewLockedByStyle.onFocused.background =
            hierarchyStyle.onFocused.background;
        locksViewLockedByStyle.onFocused.textColor =
            hierarchyStyle.onFocused.textColor;
      }
  ...
  public static GUIStyle LocksViewLockedBySelectedStyle {
    get {
      if (locksViewLockedBySelectedStyle == null) {
        ...
        // locksViewLockedBySelectedStyle.name =
        // "LocksViewLockedBySelectedStyle";
        var hierarchyStyle = GUI.skin.FindStyle("PR Label");
        locksViewLockedBySelectedStyle.onNormal.textColor =
            hierarchyStyle.onNormal.textColor;
        locksViewLockedBySelectedStyle.onNormal.background =
            hierarchyStyle.onFocused.background;
        locksViewLockedBySelectedStyle.onNormal.textColor =
            hierarchyStyle.onNormal.textColor;
        locksViewLockedBySelectedStyle.onFocused.background =
            hierarchyStyle.onFocused.background;
        locksViewLockedBySelectedStyle.onFocused.textColor =
            hierarchyStyle.onNormal.textColor;
        locksViewLockedBySelectedStyle.normal.background =
            hierarchyStyle.onFocused.background;
        locksViewLockedBySelectedStyle.normal.textColor =
            hierarchyStyle.onNormal.textColor;
      }
    ...
    get {
      if (progressAreaBackStyle == null) {
        progressAreaBackStyle =
            new GUIStyle(GUI.skin.FindStyle("ProgressBarBack"));
        // progressAreaBackStyle.name = "ProgressAreaBackStyle";
        // progressAreaBackStyle.normal.background =
        // Utility.GetTextureFromColor(new Color(194f/255f, 194f/255f,
        // 194f/255f));
    ...
    get {
      if (commitDescriptionFieldStyle == null) {
        ...
        commitDescriptionFieldStyle.padding =
            new RectOffset(HalfSpacing, HalfSpacing, HalfSpacing, HalfSpacing);
  ...
  public static Texture2D ActiveBranchIcon {
    get {
      return Utility.GetIcon("current-branch-indicator.png",
                             "current-branch-indicator@2x.png",
                             Utility.IsDarkTheme);
    }
  }

  public static Texture2D BranchIcon {
    get { return Utility.GetIcon("branch.png", "branch@2x.png"); }
  }

  public static Texture2D TrackingBranchIcon {
    get { return Utility.GetIcon("tracked-branch-indicator.png"); }
  }

  public static Texture2D FavoriteIconOn {
    get { return Utility.GetIcon("favorite-branch-indicator.png"); }
  }
  ...
  public static Texture2D SmallLogo {
    get {
      return Utility.IsDarkTheme
                 ? Utility.GetIcon("small-logo-light.png",
                                   "small-logo-light@2x.png")
                 : Utility.GetIcon("small-logo.png", "small-logo@2x.png");
    }
  }
  ...
  public static Texture2D BigLogo {
    get {
      return Utility.IsDarkTheme
                 ? Utility.GetIcon("big-logo-light.png",
                                   "big-logo-light@2x.png")
                 : Utility.GetIcon("big-logo.png", "big-logo@2x.png");
    }
  }

  public static Texture2D MergeIcon {
    get { return Utility.GetIcon("git-merge.png", "git-merge@2x.png"); }
  }
  ...
  public static Texture2D LocalCommitIcon {
    get {
      return Utility.GetIcon("local-commit-icon.png",
                             "local-commit-icon@2x.png", Utility.IsDarkTheme);
    }
  }

  public static Texture2D FolderIcon {
    get { return EditorGUIUtility.FindTexture("Folder Icon"); }
  }
  ...
  public static Texture2D LockIcon {
    get { return Utility.GetIcon("lock.png", "lock@2x.png"); }
  }
  ...
  public static Texture2D DropdownListIcon {
    get {
      return Utility.GetIcon("dropdown-list-icon.png",
                             "dropdown-list-icon@2x.png");
    }
  }
  ...
  public static Texture2D Code {
    get { return Utility.GetIcon("code.png", "code@2x.png"); }
  }

  public static Texture2D Rocket {
    get { return Utility.GetIcon("rocket.png", "rocket@2x.png"); }
  }

  public static Texture2D Merge {
    get { return Utility.GetIcon("merge.png", "merge@2x.png"); }
  }
  ...
  public static Texture2D CodeInverted {
    get { return Utility.GetIcon("code.png", "code@2x.png", true); }
  }

  public static Texture2D RocketInverted {
    get { return Utility.GetIcon("rocket.png", "rocket@2x.png", true); }
  }

  public static Texture2D MergeInverted {
    get { return Utility.GetIcon("merge.png", "merge@2x.png", true); }
  }
